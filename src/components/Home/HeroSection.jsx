...
const HeroSection = () => {
  return (
    <section
      ...
      className="relative bg-cover flex items-center md:bg-white/0 dark:bg-blend-overlay dark:bg-black bg-blend-overlay bg-white/50 justify-center bg-center bg-no-repeat h-screen -mt-36 overflow-hidden"
    >
