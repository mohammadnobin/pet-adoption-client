...
const MyDonationCampaignsPage = () => {
  ...
  const DonorModal = () => (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center px-4">
      <div className="bg-white dark:bg-black w-full max-w-md md:max-w-lg lg:max-w-xl p-6 rounded-2xl shadow-2xl relative animate-fadeIn">
        <button
          ...
          <div className="space-y-3 py-4">
            {Array(3)
              ...
              .map((_, idx) => (
                <div
                  key={idx}
                  className="p-3 bg-gray-50 text-black rounded-md shadow-sm border"
                >
    ...
    {isLoading
      ...
      : campaigns.map((donation) => {
          return (
            <div
              key={donation._id}
              className="border rounded-lg p-4 bg-white dark:bg-black dark:border-white/20 shadow"
            >
              <h3 className="text-xl font-semibold mb-1 text-secondary dark:text-white">
  ...
  {/* 💻 Desktop Table View */}
  <div className="hidden md:block overflow-x-auto rounded-lg border mt-6 dark:border-white/20">
