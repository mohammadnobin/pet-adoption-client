...
const DashboardUser = () => {
  return (
    ...
    //   <p className="text-gray-600 dark:text-white ">Manage your pets, view adoption requests, and track your donations.</p>

    //   <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    //     <div className="bg-white p-6 rounded-xl shadow-md border hover:shadow-xl transition">
    //       <FaPaw className="text-4xl  dark:text-white text-secondary mb-4" />
    ...
    //     </div>
    //     <div className="bg-white p-6 rounded-xl shadow-md border hover:shadow-xl transition">
    //       <FaHeart className="text-4xl  dark:text-white text-secondary mb-4" />
    ...
    //     </div>
    //     <div className="bg-white p-6 rounded-xl shadow-md border hover:shadow-xl transition">
    //       <FaDonate className="text-4xl  dark:text-white text-secondary mb-4" />
