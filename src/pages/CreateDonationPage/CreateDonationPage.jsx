...
const CreateDonationPage = () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-4xl mx-auto p-6 backdrop-blur custom_gradientd custom_gradientl border-2 dark:border-white border-secondary/15 shadow-lg rounded-xl">
