...
//         <div className="grid md:grid-cols-2 grid-cols-1 gap-6  xl:grid-cols-3">
//           {/* ব্লগ ১ */}
//           <div className="custom_gradientd duration-700 hover:-translate-y-6 group custom_gradientl dark:border-white border-2 border-secondary/15 p-4 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition ">
//           <div className="w-full h-56 overflow-hidden">
//             <img
//               src="https://tebewebe.online/furrescue/wp-content/uploads/sites/98/2024/03/teenager-with-acne-and-braces-confident-self-assured-and-optimistic-with-his-pet.jpg"
//               alt="Saving Lives: Vital Role of Animal Shelters in Pet Rescue Efforts"
//               className="w-full group-hover:scale-125 duration-500  h-56 object-cover"
//             />
//           </div>
//             <div className="p-4 space-y-2">
//               <div className="text-sm text-gray-500 dark:text-white flex items-center gap-1">
...
//               </p>
//               <button className="cursor-pointer text-secondary font-medium">Read more ...</button>
//             </div>
//           </div>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-6 xl:grid-cols-3">
          ...
          <div className="custom_gradientd duration-700 hover:-translate-y-6 group custom_gradientl dark:border-white border-2 border-secondary/15 p-4 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
            ...
            <div className="p-4 space-y-2">
              ...
              <button className="cursor-pointer text-secondary font-medium">
                Read more ...
              </button>
            </div>
          </div>
