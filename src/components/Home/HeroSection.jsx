...
const HeroSection = () => {
  return (
    <section
      ...
      className="relative bg-cover flex items-center md:bg-white/0 bg-blend-overlay bg-white/50 justify-center bg-center bg-no-repeat h-screen -mt-36 overflow-hidden"
    >
      {/* Wave Brush Bottom Shape */}
      <div className="absolute bottom-0 rotate-180 left-0 w-full">
        <svg
      ...
      <div className=" flex flex-col md:flex-row items-center justify-between gap-10 animate-fadeIn">
        ...
        <div className="space-y-6 max-w-xl">
          ...
          >
            View Pets <MdOutlineArrowRightAlt size={30} />
          </Link>
        </div>
        </Slide>
      </div>
...
//       <div className="relative z-10 container mx-auto px-4 py-20 flex flex-col md:flex-row items-center justify-between gap-10 animate-fadeIn text-white">
//         {/* Left Side */}
//         <div className="space-y-6 max-w-xl">
...
//           <Link
//             to="/puppies"
//             className="inline-flex items-center gap-2 px-6 py-3 bg-secondary text-white rounded-md text-sm font-semibold hover:bg-secondary/90 transition"
//           >
//             View Puppies <i className="fas fa-long-arrow-alt-right"></i>
//           </Link>
//         </div>

//         {/* Right Side - Optional image or empty for now */}
